...
My model is inspired by this [thesis](http://cs231n.stanford.edu/reports/2016/pdfs/262_Report.pdf). Itoutperforms the model introduced in this thesis by around 2-3% in test accuracy thanks to data augmentation and other factors.
